...
ifeq (0, $(shell test $(PLATFORM_SDK_VERSION) -lt 34; echo $$?))
...
ifeq ($(TARGET_SUPPORTS_DDR_SUFFIX),true)
	FSTAB_DDR_SUFFIX := FSTAB_DDR_SUFFIX=1
else
	FSTAB_DDR_SUFFIX := FSTAB_DDR_SUFFIX=0
endif
